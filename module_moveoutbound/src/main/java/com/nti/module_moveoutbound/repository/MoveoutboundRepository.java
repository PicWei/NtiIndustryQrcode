 ...
 * @describe
 */
public class MoveoutboundRepository {
        ...
        HttpUtils.getInstance().with(IMoveoutboundService.class).PDA_H(paramer)
                ...
                .subscribe(new Observer<JsonObject>() {
                    ...
                    public void onNext(@NotNull JsonObject jsonObject) {
                        ...
                        try {
                            LitePal.deleteAll(MoveoutboundDetail.class);
                        ...
                        try {
                            ...
                            /*if (object.has("BB_TOTAL_SCAN_NUM")){
                                ...
                                try {
                                    List<MoveoutboundDetail> details = LitePal.where("BD_BB_UUID = ?", BB_UUID).find(MoveoutboundDetail.class);
