 ...
 * @describe
 */
public class ProduceoutboundOrderInfo extends LitePalSupport {
    //单据uuid
    ...
    public ProduceoutboundOrderInfo(String BB_UUID, String BB_CONTRACT_NO, String BB_BT_CODE, String BB_TICKET_NO,
    ...
    public String toString() {
        return "ProduceoutboundOrderInfo{" +
                "BB_UUID='" + BB_UUID + '\'' +
