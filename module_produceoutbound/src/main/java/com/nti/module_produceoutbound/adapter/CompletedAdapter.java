...
import com.nti.module_produceoutbound.databinding.PocompletedItemBinding;
...
public class CompletedAdapter extends RecyclerView.Adapter<CompletedAdapter.ViewHolder>{
    ...
    public CompletedAdapter(Context context, List<ProduceoutboundOrderInfo> orderInfos) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        PocompletedItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.pocompleted_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        PocompletedItemBinding binding;

        public ViewHolder(PocompletedItemBinding binding) {
    ...
    public interface onCheckListener{
        void onCheckChange(List<ProduceoutboundOrderInfo> orderInfos);
    }
}
