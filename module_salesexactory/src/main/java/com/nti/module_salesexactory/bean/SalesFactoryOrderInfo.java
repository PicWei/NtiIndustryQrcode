 ...
 * @describe
 */
public class SalesFactoryOrderInfo extends LitePalSupport {
    //单据uuid
    ...
    public SalesFactoryOrderInfo(String BB_UUID, String BB_CONTRACT_NO, String BB_BT_CODE, String BB_TICKET_NO,
