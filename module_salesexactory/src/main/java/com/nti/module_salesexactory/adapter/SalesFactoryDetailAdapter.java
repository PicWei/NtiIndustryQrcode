...
import com.nti.module_salesexactory.databinding.SalesfactorydetailItemBinding;
 ...
 * @describe
 */
public class SalesFactoryDetailAdapter extends RecyclerView.Adapter<SalesFactoryDetailAdapter.ViewHolder>{

    private List<SalesFactoryDetail> details;
    private Context context;
    private LayoutInflater inflater;
    private OnItemClickListener onItemClickListener;

    public SalesFactoryDetailAdapter(List<SalesFactoryDetail> details, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        SalesfactorydetailItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.salesfactorydetail_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        SalesFactoryDetail detail = details.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        SalesfactorydetailItemBinding binding;

        public ViewHolder(SalesfactorydetailItemBinding binding) {
    ...
    public interface OnItemClickListener{
        void onItemClick(SalesFactoryDetail detail);
    }
}
