...
import com.nti.module_salesexactory.databinding.CompletedItemBinding;
import com.nti.module_salesexactory.databinding.SscompletedItemBinding;
...
public class CompletedAdapter extends RecyclerView.Adapter<CompletedAdapter.ViewHolder>{
    ...
    public CompletedAdapter(Context context, List<SalesFactoryOrderInfo> orderInfos) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        SscompletedItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.sscompleted_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        SscompletedItemBinding binding;

        public ViewHolder(SscompletedItemBinding binding) {
    ...
    public interface onCheckListener{
        void onCheckChange(List<SalesFactoryOrderInfo> orderInfos);
    }
}
