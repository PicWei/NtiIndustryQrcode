                    ...
                    public void onNext(@NotNull JsonObject jsonObject) {
                        ...
                        try {
                            for (int i = 0; i < jsonArray1.size(); i++){
                                ...
                                try {
                                    List<SalesBarcode> barcodes = LitePal.where("UUID = ? and pcigcode = ? and isSubmit = 0", uuid, pickCode).find(SalesBarcode.class);
                                    ...
                                    SalesFactoryDetail salesFactoryDetail = new SalesFactoryDetail(pickName, billPNum, billBNum, uuid, pickCode, scanBNum, String.valueOf(mscanQty));
                        ...
                        try {
                            LitePal.deleteAll(SalesFactoryDetail.class);
                        ...
                        try {
                            ...
                            /*if (object.has("BB_TOTAL_SCAN_NUM")){
                                ...
                                try {
                                    List<SalesFactoryDetail> details = LitePal.where("BD_BB_UUID = ?", BB_UUID).find(SalesFactoryDetail.class);
