 ...
 * @describe
 */
public class ScrapCodeDetail extends LitePalSupport {
    // 件烟品牌规格名称
    ...
    public ScrapCodeDetail(String BD_PCIG_NAME, String BD_BILL_PNUM, String BD_BILL_BNUM, String BD_BB_UUID, String BD_PCIG_CODE, String BD_SCAN_BNUM, String BD_SCAN_NUM) {
