 ...
 * @describe
 */
public class ScrapCodeBarcode extends LitePalSupport {
    private String UUID;
    ...
    public ScrapCodeBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
