 ...
 * @describe
 */
public class ScrapCodeOrderInfo extends LitePalSupport {
    ...
    public ScrapCodeOrderInfo(String BB_UUID, String BB_CONTRACT_NO, String BB_BT_CODE, String BB_TICKET_NO,
