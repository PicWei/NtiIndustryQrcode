 ...
 * @describe
 */
public class ScrapBarcode extends LitePalSupport {
    private String UUID;
    ...
    public ScrapBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
