 ...
 * @describe
 */
public class ProduceInboundBarcode extends LitePalSupport {
    private String UUID;
    ...
    public ProduceInboundBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
